...
reach a given +ve target number. You can only use the following two operations:

1. Add 1
2. Double the number

Example:
For Target = 18, output = 6,
...
For Target = 69, output = 9,
because it takes at least 8 steps to reach reach the target.
