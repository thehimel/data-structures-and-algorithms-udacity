...
For our blockchain, we will be using an SHA-256 hash, the Greenwich Mean Time
(GMT) when the block was created, and text strings as the data.

Use your knowledge of linked lists and hashing to create
