...
representing friends in your contacts.
This list is stored in the variable people.
...
2.	Complete the function get_most_common_month(people).
    This function should return the name of the month with
    the most number of birthdays among your friends.
